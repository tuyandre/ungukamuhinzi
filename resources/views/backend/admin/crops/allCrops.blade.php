        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header d-flex align-items-center">
                    <h4 class="modal-title" id="exampleModalLabel1">Add New Crops</h4>
                ...
                <form data-parsley-validate class="form-horizontal" method="POST" action="{{route('admin.crops.store')}}" id="frmSave">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-primary" id="btnSave" data-loading-text="Loading..." value="Save Crop"/>
                    </div>
                </form>
            </div>
        </div>
                ...
                $.ajax({
                    ...
                    if (data.crop == "ok") {
                        ...
                        $('#add-messages').html('<div class="alert alert-success flat">' +
                            ...
                            '<strong><i class="glyphicon glyphicon-ok-sign"></i></strong> Crop successfully Uploaded. </div>');
