                        ...
                        <div class="col-md-9 col-md-offset-2 mx-auto text-center">
                            <div class="myform form ">
                                <form class="formValidate" id="contactForm" action="" method="post" name="login"    e.preventDefault();>
                                    ...
                                    <div class="form-group">
                                        <input type="email" name="email" class="form-control my-input" id="email111" placeholder="Email" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="number" name="phone" class="form-control my-input" id="phone111" placeholder="Phone number" required>
                                    </div>
                                    <div class="form-group">
...
@endsection
@section('js')
    <script src="{{asset('frontend/js/adminRegister.js')}}"></script>
